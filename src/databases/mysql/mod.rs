...
impl Executor for MySQL {
    ...
    fn to_sql<'q>(&self, _statement: &'q Statement<Self::T>) -> String {
        todo!()
    }
    ...
    async fn insert<'q>(&self, _statement: &'q Statement<Self::T>) -> Result<()> {
        todo!()
    }
    
    async fn insert_as<'q, O>(&self, _statement: &'q Statement<Self::T>) -> Result<O>
    where
    ...
    async fn update<'q>(&self, _statement: &'q Statement<Self::T>) -> Result<()> {
        todo!()
    }
    
    async fn count<'q>(&self, _statement: &'q Statement<Self::T>) -> Result<u64> {
        return Ok(0);
    }
    
    async fn delete<'q>(&self, _statement: &'q Statement<Self::T>) -> Result<()> {
        todo!()
    }
    ...
    async fn all<'q, O>(&self, _statement: &'q Statement<Self::T>) -> Result<Vec<O>>
    where
        O: for<'r> FromRow<'r, <Self::T as sqlx::Database>::Row> + Send + Unpin + Sized {
        todo!()
    }

    async fn first<'q, O>(&self, _statement: &'q Statement<Self::T>) -> Result<O>
    where
        O: for<'r> FromRow<'r, <Self::T as sqlx::Database>::Row> + Send + Unpin + Sized {
        todo!()
    }

    async fn paginate<'q, O>(&self, _statement: &'q Statement<Self::T>) -> Result<Pagination<O>>
    where
        O: for<'r> FromRow<'r, <Self::T as sqlx::Database>::Row> + Send + Unpin + Sized {
        todo!()
    }
